...
class CharacterEditorState extends MusicBeatState
{
	...
	function reloadCharacterDropDown() {
		...
		#if MODS_ALLOWED
		characterList = [];
		var directories:Array<String> = [Paths.mods('characters/'), Paths.mods(Paths.currentModDirectory + '/characters/') #if android, SUtil.getPath() + Paths.getPreloadPath('characters/') #end];
