...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		pauseArt.loadGraphic(Paths.image('Renders/' + PlayState.SONG.player2() + PlayState.instance.pausePortraitPrefix[0], 'shared'));
		pauseArt.scrollFactor.set();
		if (!OpenFlAssets.exists(Paths.getPath('Renders/' + PlayState.SONG.player2() + PlayState.instance.pausePortraitPrefix[0] + '.png', IMAGE, 'shared'))) add(pauseArt);
		...
		FlxTween.tween(bg, {alpha: 0.6}, 0.4, {ease: FlxEase.quartInOut});
	        FlxTween.tween(hello, {alpha: 1}, 0.55, {ease: FlxEase.quartInOut});
