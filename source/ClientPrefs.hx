...
class ClientPrefs {
	...
	//mod shit times 2
	public static var beatDuke:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.ducclymix = ducclyMix;

		FlxG.save.flush();

		var save:FlxSave = new FlxSave();
		save.bind('controls_v3', 'Harbinger'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		...
		var save:FlxSave = new FlxSave();
		save.bind('controls_v2', 'Harbinger');
